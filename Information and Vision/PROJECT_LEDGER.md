...
## Entries preserved from the parallel `main` copy of this ledger (merged 2026-07-16)

> These lines existed only in main's copy of this file. The two branches kept separate,
> diverged ledgers with no common ancestor; both are preserved here rather than losing either.
> The ACTIVE ledger is `docs/governance/PROJECT_LEDGER.md` — this file is a historical artifact.
